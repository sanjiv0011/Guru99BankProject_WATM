package com.guru99bankProject.projectUtility;
								...
								try 
								{
									...
									else if(wantToclickOnFindSearckKey) 
									{
											...
											if(callerMethodName.equals("findPackageBuyersUserFromList")) {
												...
												elementFindKey = driver.findElement(By.xpath("(//*[translate(normalize-space(),'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz')='"+yourUniqueValue+"'])[2]"));
												
											}else {
												yourUniqueValue = formatText.toLowerCase().trim();
												elementFindKey = driver.findElement(By.xpath("(//*[translate(normalize-space(),'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz')='"+yourUniqueValue+"'])[1]"));
