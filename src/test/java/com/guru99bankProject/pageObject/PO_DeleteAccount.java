...
public class PO_DeleteAccount extends ReUseAbleElement {
	...
	public PO_DeleteAccount(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	// TO DELETE ACCOUNT
	public PO_HomePage deleteAccount(String accountNumber)
			throws InterruptedException {
		logger.info("Method called:" + "deleteAccount");
